    ...
    for row in input_feat_list:
        for eval_feat in row:
            ...
            if eval_type == 'grp_count':
                ...
                input_list.extend([(sample, agree_size, disagree_size, disagree_type, order) for sample in mmlu_input])
                ...
                disagree_type = eval_feat['disagree_type']
                order = eval_feat['order']
                input_list.extend([(sample, group_size, disagree_ratio, disagree_type, order) for sample in mmlu_input])
